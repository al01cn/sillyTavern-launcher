...
LangString alreadyInstalledLong ${LANG_SIMPCHINESE} "$(shortcutName) ${VERSION} 已经安装了。选择你想要执行的操作后点击下一步以继续。"
...
LangString choowHowToInstall ${LANG_SIMPCHINESE} "选择你想要安装 $(shortcutName) 的方式。"
...
LangString newerVersionInstalled ${LANG_SIMPCHINESE} "有一个更新版本的 $(shortcutName) 已经安装了！不推荐你安装旧的版本。如果你真的想要安装这个旧的版本，推荐先卸载当前版本。选择你想要执行的操作后点击下一步以继续。"
LangString older ${LANG_SIMPCHINESE} "旧的"
LangString olderOrUnknownVersionInstalled ${LANG_SIMPCHINESE} "系统中已存在版本为 $R4 的 $(shortcutName)。推荐先卸载当前版本后再进行安装。选择你想要执行的操作后点击下一步以继续。"
...
LangString uninstallApp ${LANG_SIMPCHINESE} "卸载 $(shortcutName)"
