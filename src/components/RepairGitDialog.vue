    ...
    >
        ...
        >
            ...
            <div class="px-5 py-3 bg-slate-800 border-t border-slate-700 flex items-center justify-between gap-3">
                ...
                <div v-else-if="repairGitDialogState.result === 'success'" class="flex items-center gap-2 text-emerald-400 text-xs font-medium">
                    <CheckCircle2 class="w-3.5 h-3.5" />
                    <span>{{ t('extensions.repairGitSuccess') }}</span>
                </div>
                <div v-else-if="repairGitDialogState.result === 'offline'" class="flex items-center gap-2 text-amber-400 text-xs font-medium min-w-0">
                    <WifiOff class="w-3.5 h-3.5 shrink-0" />
                    <span class="break-all">{{ t('extensions.repairGitOffline') }}</span>
                </div>
                <div v-else-if="repairGitDialogState.result === 'error'" class="flex items-center gap-2 text-red-400 text-xs font-medium">
                ...
                <button
                    ...
                    :class="repairGitDialogState.isRepairing
                        ? 'bg-slate-600'
